...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
		<form class="layui-form" action="<%=path %>/user/update" method="post">
		
		<div class="layui-form-item">
		    <label class="layui-form-label">用户编号</label>
		    <div class="layui-input-block" style="width:300px">
		      <input type="text" name="id" value="${user.id }" lay-verify="name" readonly="readonly" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-inline" style="width:300px">
		      <input type="text" name="name" value="${user.name }" lay-verify="name" placeholder="请输入" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<c:forEach items="${roles }" var="role" varStatus="status">
		    		<c:if test="${role.has}">
		    			<input type="checkbox" name="roles" title="${role.name }" value="${role.id }" checked="">
		    		</c:if>
		    		<c:if test="${!role.has}">
