...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
		<form class="layui-form" action="<%=path %>/authority/update" method="post">
		  <div class="layui-form-item">
		    <label class="layui-form-label">权限编号</label>
		    <div class="layui-input-inline" style="width:300px">
		      <input type="text" name="id" pautocomplete="off" value="${authority.id }" class="layui-input" readonly="readonly">
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label">权限名</label>
		    <div class="layui-input-inline" style="width:300px">
		      <input type="text" name="name" lay-verify="name" placeholder="请输入" value="${authority.name }" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  <div class="layui-form-item">
