    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd class="layui-this"><a href="<%=path %>/role_index.jsp">查询角色</a></dd>
...
<table class="layui-table" lay-data="{width: 892, height:483, url:'role/getAll', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
		  ...
		  table.on('tool(demo)', function(obj){
		    ...
		    if(obj.event === 'del'){
		      layer.confirm('真的删除行么', function(index){
		    	 window.location.href="role/deleteById/"+data.id;
		      });
		    } else if(obj.event === 'edit'){
		    	window.location.href="role/findById/"+data.id;
		    }
		  });
		});
</script>
