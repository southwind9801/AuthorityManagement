    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed"><a href="javascript:;">用户管理</a>
          <dl class="layui-nav-child">
            <dd class="layui-this"><a href="<%=path %>/user_index.jsp">查询用户</a></dd>
...
<table class="layui-table" lay-data="{width: 892, height:483, url:'user/getAll', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
